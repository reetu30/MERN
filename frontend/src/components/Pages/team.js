...
import { TEAM_IMG1, TEAM_IMG2, TEAM_IMG3, TEAM_IMG4 } from '../constant/constant'
            ...
            <div  className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6 ">
                ...
                <div  className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
                    <div  className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        <a  >
                            <img  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={TEAM_IMG1} alt="Bonnie Avatar"/>
                        </a>
                        <div  className="p-5">
                    ...
                    <div  className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        <a  >
                            <img  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={TEAM_IMG2} alt="Jese Avatar"/>
                        </a>
                        <div  className="p-5">
                            <h3  className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a  >Jese Leos</a>
                    ...
                    <div  className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        <a  >
                            <img  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={TEAM_IMG3} alt="Michael Avatar"/>
                        </a>
                        <div  className="p-5">
                            <h3  className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a  >Michael Gough</a>
                    ...
                    <div  className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
                        <a  >
                            <img  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src={TEAM_IMG4} alt="Sofia Avatar"/>
                        </a>
                        <div  className="p-5">
                            <h3  className="text-xl font-bold tracking-tight text-gray-900 dark:text-white">
                                <a  >Lana Byrd</a>
